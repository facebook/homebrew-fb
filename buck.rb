...
class Buck < Formula
  @@buck_version = "2016.09.02.01"
  desc "The Buck build system"
  homepage "https://buckbuild.com/"
  head "https://github.com/facebook/buck.git"
  version @@buck_version
  url "https://api.github.com/repos/facebook/buck/tarball/v2016.09.02.01"
  sha256 "02ec3a88b2bc0500a39e0cc2ab33df0244e94a8a058638951c69064813eac87d"

  bottle do
    root_url "https://github.com/facebook/buck/releases/download/v#{@@buck_version}"
    cellar :any_skip_relocation
    sha256 "efdd9f1be082c454c3eceae145fb74fe1c1559962b9e255b7917bdc928b98643" => :yosemite_or_later
  end
